...
from .views import AssignmentViewSet, QuestionViewSet, SolutionViewSet, TestViewSet, UploadViewSet
...
nbauthor_router.register(r'upload', UploadViewSet, basename="upload")
